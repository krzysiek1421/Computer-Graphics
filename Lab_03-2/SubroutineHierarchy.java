...
public class SubroutineHierarchy extends JPanel {
    ...
    private void updateFrame() {
        ...
        public void wholeWorld(Graphics2D g2){
        ...
        g2.setTransform(saveTransform);
        g2.scale(0.7, 1);
        g2.translate(-3.7,0.2);
        g2.setColor(Color.red);
        g2.setStroke(new BasicStroke((float) 0.2));
        g2.draw( new Line2D.Double( -0.8,2, 2,1.4) );
        g2.setTransform(saveTransform);
        g2.translate(-2.7, 1.7);
        g2.setColor(new Color(134,15,130));
        g2.scale(0.7, 0.8);
        triangle(g2);
        g2.setTransform(saveTransform);
        ...
        g2.draw( new Line2D.Double( -0.8,2, 2,1.4) );
        g2.setTransform(saveTransform);
        g2.translate(1.8, 1.9);
        g2.setColor(new Color(32,111,12));
        g2.scale(0.5, 0.6);
        triangle(g2);
    }
    ...
    private void line(Graphics2D g2) {
        g2.setColor(Color.red);
