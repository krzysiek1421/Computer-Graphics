...
public class SceneGraph extends JPanel {
    ...
    private TransformedObject t1,r1, fp1_1, fp1_2;

    private TransformedObject t2,r2, fp2_1, fp2_2;

    private TransformedObject t3,r3, fp3_1, fp3_2;
    /**
    ...
    private void createWorld() {
        ...
        // TODO: Create objects and add them to the scene grap

        t1 = new TransformedObject(filledTriangle);
        t1.setTranslation(0, -2.9);
        t1.setColor(Color.blue);
        t1.setScale(0.9, 2);
        r1 = new TransformedObject(filledRect);
        r1.setColor(Color.red);
        r1.setTranslation(0,-0.9);
        r1.setScale(3.3,0.2);
        r1.setRotation(-20);
        fp1_1 = new TransformedObject(filledPolygon);
        fp1_1.setColor(Color.black);
        fp1_1.setScale(0.05,0.05);
        fp1_1.setTranslation(-1.5,-0.35);
        fp1_2 = new TransformedObject(filledPolygon);
        fp1_2.setColor(Color.black);
        fp1_2.setScale(0.05,0.05);
        fp1_2.setTranslation(1.5,-1.35);
        world.add(fp1_2);
        world.add(fp1_1);
        world.add(r1);
        world.add(t1);
        ...
        t2.setScale(0.7,1.6);
        t2.setColor(new Color(128,0,128));
        t2.setTranslation(-2.5,0.5);
        r2 = new TransformedObject(filledRect);
        r2.setScale(2.5,0.15);
        r2.setColor(Color.red);
        r2.setTranslation(-2.5,2.1);
        r2.setRotation(-20);
        fp2_1 = new TransformedObject(filledPolygon);
        fp2_1.setColor(Color.black);
        fp2_1.setScale(0.03,0.03);
        fp2_1.setTranslation(-3.5,2.5);
        fp2_2 = new TransformedObject(filledPolygon);
        fp2_2.setColor(Color.black);
        fp2_2.setScale(0.03,0.03);
        fp2_2.setTranslation(-1.5,1.7);
        world.add(fp2_2);
        world.add(fp2_1);
        world.add(r2);
        world.add(t2);
        ...
        t3.setScale(0.5, 1.3);
        t3.setColor(new Color(0,128,0));
        t3.setTranslation(2.6,0.95);
        r3 = new TransformedObject(filledRect);
        r3.setRotation(-20);
        r3.setColor(Color.red);
        r3.setScale(2.3,0.1);
        r3.setTranslation(2.6,2.25);
        fp3_1 = new TransformedObject(filledPolygon);
        fp3_1.setColor(Color.black);
        fp3_1.setScale(0.02,0.02);
        fp3_1.setTranslation(1.5,2.6);
        fp3_2 = new TransformedObject(filledPolygon);
        fp3_2.setColor(Color.black);
        fp3_2.setScale(0.02,0.02);
        fp3_2.setTranslation(3.6,1.9);
        world.add(fp3_2);
        world.add(fp3_1);
        world.add(r3);
        world.add(t3);
    ...
    public void updateFrame() {
        ...
        fp1_1.setRotation(frameNumber*0.75);
        fp1_2.setRotation(frameNumber*0.75);
        fp2_1.setRotation(frameNumber*0.75);
        fp2_2.setRotation(frameNumber*0.75);
        fp3_1.setRotation(frameNumber*0.75);
        fp3_2.setRotation(frameNumber*0.75);
    }
    ...
    private static SceneGraphNode filledPolygon = new SceneGraphNode() {
        void doDraw(Graphics2D g) {
            ...
            g.fill(new Polygon(xPoints,yPoints,numberOfEdges));
        }
    };
